...
const isOwner = [`${setting.ownerNumber}`,"6287751970702@s.whatsapp.net","6287751970702@s.whatsapp.net"].includes(sender) ? true : false
...
const gurbot = '6287751970702@s.whatsapp.net'
